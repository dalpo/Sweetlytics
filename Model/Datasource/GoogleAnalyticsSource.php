...
class GoogleAnalyticsSource extends DataSource {
  ...
  public function account_data($queryData) {
  ...
  public function __validateQueryData($queryData) {
    ...
    if (strtotime($conditions['start-date']) > strtotime($conditions['end-date'])) {
  ...
  public function __buildParams($queryData) {
  ...
  public function __dataPoints($feed) {
    $dataPoints = array();
  ...
  public function __parseDataPoint($dataPoint) {
    if (empty($dataPoint)) {
      return array();
    }
  ...
  public function __request($method = 'get', $path = '', $params = array()) {
    ...
    $response = $this->Http->{$method}($this->base_url . $path, $params, $request);
  ...
  public function __extract_property_value($entry, $property) {
    ...
    $value = Set::extract("/property[name=ga:$property]/value", $entry);
